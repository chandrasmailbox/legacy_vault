            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2.w),
                  _buildInfoStep(context, '1', 'Trusted Contact Request',
                      'Your emergency contact initiates an access request'),
                  _buildInfoStep(context, '2', 'Waiting Period',
                      'A $_waitingPeriod-hour waiting period begins for your security'),
                  _buildInfoStep(context, '3', 'Notification & Override',
                      'You receive notifications and can deny the request'),
                  _buildInfoStep(context, '4', 'Vault Access Granted',
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content:
                      Text('Emergency access setup will be available soon'),
                ),
              );
            },
